...
public class catalogoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (formId.equals("1"))
            {
                String strNombreLugar = request.getParameter("nombreLugar");
            ...
            //Transformar números
            float iLatitud = Float.parseFloat(strLatitud);
            float iLongitud = Float.parseFloat(strLongitud);
            ...
            int rows = logic.InsertCatalogo(strNombreLugar, strCategoria, iLatitud, iLongitud);
            
            request.getSession().setAttribute("rows", rows);
            response.sendRedirect("respuestaCatalogo.jsp");
        }
    }
    }
