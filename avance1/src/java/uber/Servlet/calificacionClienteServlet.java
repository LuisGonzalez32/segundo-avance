...
import uber.logic.calificacionClienteLogic;


@WebServlet(name = "calificacionClienteServlet", urlPatterns = {"/calificacionClienteServlet"})
public class calificacionClienteServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            calificacionClienteLogic logic = new calificacionClienteLogic(connString);
            
            int rows = logic.InsertCalificacionConductor(iConductor, iCliente, iCalificacion);
