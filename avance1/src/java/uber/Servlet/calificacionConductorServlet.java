...
import uber.logic.calificacionConductorLogic;


@WebServlet(name = "calificacionConductorServlet", urlPatterns = {"/calificacionConductorServlet"})
public class calificacionConductorServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            calificacionConductorLogic logic = new calificacionConductorLogic(connString);
            
            int rows = logic.InsertCalificacionConductor(iCliente, iConductor, iCalificacion);
